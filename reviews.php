<!--  BUS DRIVER REVIEW DISPLAY PAGE  -->
...
<body>
  ...
  <section class="page-content">
    <section class="grid" style="text-align: center;">
      ...
      <article class="review-content" style="height: 100%;">

        <h2 style="margin-top: 25px; margin-bottom: 30px;">What Passengers Say About You</h2>

        <div class="reviewss">

          <!-- Display only reviews made to the logged in account dynamically -->
          <?php
          $email = $_SESSION['user'];
              ...
              foreach ($users as $user) {
                if ($user->email == $email) {
                  if ($row['receivers'] == $email) {
                    ...
                    <article class="review-content" id="review-display-container" style="width:100%;">
                      <form method="post" action="" id="review-display-form">
                        ...
                        <input type="text" name="rating" value="Rating given to you: <?php // displays rating being returned from the database
                                                                                    switch ($rating) {
                                                                                      case 1: {
                                                                                        ?>★<?php
                                                                                        break;
                        ...
                        <input type="text" name="receiver" value="From: <?= $senders; ?>" id="review-display-input-email">
                      </form>
