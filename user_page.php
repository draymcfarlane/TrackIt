      ...
      <section class="grid" style="text-align: center;">
        ...
        <article class="top-grid">
          ...
          <div class="text">
            ...
            <a href="pass-routes.php">Check out routes -></a>
          </div>
        </article>
        ...
        <article class="bottom-grid">
          <div class="text">
            ...
            <p>Request a pick up from a bus driver.</p>
            <a href="pick-up.php">Enter request here -></a>
          </div>
          <img src="images/BUS.png" alt="bus-img">
        </article>

        <article class="top-grid">
          <img src="images/ratings.png" alt="map-img">
          <div class="text">
            <h2>Make A Review</h2>
            <p>Send a review to a bus driver and let them know your experience.</p>
            <a href="pass-reviews.php">Check out reviews -></a>
          </div>
        </article>
